<?php
/**
 * Template name: Archive Media Overview
 */
?>
<?php get_header(); ?>
	<section id="two-third" class="media-overview">
		<h1><?php _e('Welcome to our Media Library Overview Page (Multimedia)', 'globalconcept') ?></h1>
    <?php 
...
function changept() {
	if( is_category() && !is_admin() )
		set_query_var( 'post_type', array( 'multimedia' ) );
